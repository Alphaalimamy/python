...
print('The commission for salesperson 1 is $', format(commission1, ',.2f'), sep='')
...
print('The commission for salesperson 2 is $', format(commission2, ',.2f'), sep='')
...
print('The commission for salesperson 3 is $', format(commission3, ',.2f'), sep='')
